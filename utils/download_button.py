...
<br>I file da te comunque prodotti come allegati per questo esercizio in modo_libero di svolgimento devono invece essere disposti nella cartella:<br> <b>@path_ex_folder@/modo_libero/allegati/</b></em>
</font>
"""
display(HTML(html))
